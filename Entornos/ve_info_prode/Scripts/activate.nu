...
def-env activate-virtualenv [] {
    ...
    let virtual-env = 'C:\Users\HP\Documents\Informatorio python\prode_info_qatar22\Entornos\ve_info_prode'
    let bin = 'Scripts'
    let path-sep = ';'
...
alias deactivate = source 'C:\Users\HP\Documents\Informatorio python\prode_info_qatar22\Entornos\ve_info_prode\Scripts\deactivate.nu'
